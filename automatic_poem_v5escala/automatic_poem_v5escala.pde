...
float E_n, E_art, E_ad, E_v, E_c, E_s2, E_v2, E_obj, E_e, E_seja; 
// Int value that picks random string inside list
int Nx, Vx, Ax, Cj, Vx2, Sx2, obj2, Advx, Ox, Artx; 
...
int posN, posV, posAdj, posC, posS2, posV2, posO, posArt;
