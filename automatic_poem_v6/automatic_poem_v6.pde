...
// Strings for the second frase.
String C, V2, S2;
// Strings for the third frase.
String seja, Obj2, E;
...
float E_n, E_art, E_ad, E_v, E_c, E_s2, E_v2, E_obj, E_e, E_seja, E_art2; 
// Int value that picks random string inside list
int Nx, Vx, Ax, Cj, Vx2, Sx2, obj2, Advx, Ox, Artx, Artx2; 
...
int posN, posV, posAdj, posC, posS2, posV2, posO, posArt, posArt2;
